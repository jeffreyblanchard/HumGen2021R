---
title: "Human Genome Analysis Lab 5 : Publication Graphics"
output:
  html_document:
    toc: true
    toc_depth: 4
...
Using ggplot make a make a bar graph of the total SNP counts for each chromosome. Add title and labels for the x and y axis to Lab3 ex1. Set the fill of the bars to yellow and the outline (color) to black.
...
Turn ex3 into an interactive graph using plotly. Note: Titles in plotly often need to be wrapped. I do this using `labs(title = str_wrap("Total number of SNPs on each chromosome", 40).
