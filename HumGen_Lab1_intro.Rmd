...
If you are an undergraduate in 497 go to [RStudio Cloud](https://rstudio.cloud/) and create an account. I will share the link for our Workspace in Chat. The steps are
...
If you are a graduate student in 697 install R and RStudio on your own computer or use the MGHPCC [Instructions](MGHPCC.html). Course materials will be available through our [Github repository](https://github.com/jeffreyblanchard/RGenome2021)
...
* Open RMarkdown_template.Rmd
* Save as a different file (e.g. Lab1_yourname.Rmd)
* Change the title (e.g. Lab 1) and add your name as the author. Select html as the Default Output Format.
* Cut and paste your answer for the exercise from your .R file into this .Rmd file. Make sure your R code is within the code chunks that start with
...
* If you are working on RStudio Cloud or the MGPHCC You will need to first export the your Lab1_yourname.html file to yourcomputer.

![](images/Export.png)
* Then upload the file to Moodle
