...
Using the provided Rmd HumGen_Lab8_genetic_ancestors_code.Rmd file. Make new graphs of back 6, 8, 10 and 12 generations. You are going to need to change the legend text size as you add generations. Discuss the pattern of inheritance you observe. This is the only file to hand in today.
