...
If you NOT using RStudio Cloud you will need to download this file from [RGenome2021 GitHub](https://github.com/jeffreyblanchard/EvolutionaryGenomicsR/tree/master/data).

* data/pinfsc50_filtered.vcf.gz

You will also have to install the `vcfR` packages 
