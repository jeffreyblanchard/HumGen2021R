---
title: "Lab 9: Population genomics based on high throughput sequencing (HTS)"
output:
  html_document:
    toc: true
    toc_depth: 4
...
### If you NOT using RStudio Cloud. 

If you NOT using RStudio Cloud you will need to download this files from [RGenome2021 GitHub](https://github.com/jeffreyblanchard/EvolutionaryGenomicsR/tree/master/data).

* data/bibtexlib.bib
* data/style.R
* data/pinfsc50_filtered.vcf.gz

You will also have to install the `vcfR`, `knitr` and `knitrcitations` packages 
